...
export default function Create() {
    ...
    const levelOptions = [
        ...
        { label: "Moderadamente (exercícios 3 a 5 vezes na semana)", value: "Moderamente (exercícios 3 a 5 vezes na semana)" },
        { label: "Altamente ativo (exercícios 5 a 7 vezes por semana)", value: "Altamente ativo (exercícios 5 a 7 vezes na semana)" },
    ]
    ...
    return(
        <View style={styles.container}>
           ...
           <ScrollView style={styles.content}>
                ...
                >
                    <Text style={styles.buttonTxt}>Avançar</Text>
                </Pressable>
           </ScrollView>
        </View>
    )
